#taken from the example phenology github https://github.com/eco4cast/neon4cast-phenology
...
forecast <- subset(forecast, site_id=='UNDE' | site_id=='ABBY' | site_id=='TEAK')
...
team_list <- list(list(individualName = list(givenName = "Cazimir", 
                                             surName = "Kowalski"),
                       organizationName = "Notre Dame",
                       electronicMailAddress = "ckowals@nd.edu"))
